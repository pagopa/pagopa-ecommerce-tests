...
class ClosedPendingTransactionTests(
  ...
  @Test
  fun `Should write event in DLQ for transaction stuck in CLOSED status that have not receive send payment result yet`() {
    // pre-conditions
      ...
      IntegrationTestData(
        ...
        view =
          TransactionTestUtils.transactionDocument(
            TransactionStatusDto.CLOSED, ZonedDateTime.now()),
